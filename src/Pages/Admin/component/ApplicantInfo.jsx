...
const ApplicantInfo = ({ id, isOpen, closeModal }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="bg-white p-8 rounded shadow-lg z-10 w-2/3 relative flex flex-col md:flex-row mx-auto">
                <div className="w-3/5 mb-6 md:mb-0 p-8 relative space-y-8">
